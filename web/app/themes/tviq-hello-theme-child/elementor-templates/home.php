...
<section class="list-section">
	<div class="wrap">
		...
		<div class="num-item"><h3>Omni-Channel Video and Audio Revenue Operations</h3><span class="desc-inline">Ad server, SSAI &amp; SSP configuration, inventory architecture, technical revenue audits.</span></div>
