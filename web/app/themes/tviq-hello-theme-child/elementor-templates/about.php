...
<section class="team-panel">
  <div class="wrap">
    ...
    <div class="team-grid">
      <div class="t-card"><img class="avatar" src="<?php echo esc_url( $tviq_team_img ); ?>scott-ryan.jpg" width="78" height="78" loading="lazy" decoding="async" alt=""><h5>Scott Ryan</h5><span>CEO</span><a href="mailto:sryan@tviq.io">sryan@tviq.io</a></div>
      <div class="t-card"><img class="avatar" src="<?php echo esc_url( $tviq_team_img ); ?>sara-sinclair.jpg" width="78" height="78" loading="lazy" decoding="async" alt=""><h5>Sara Sinclair</h5><span>COO</span><a href="mailto:ssinclair@tviq.io">ssinclair@tviq.io</a></div>
      <div class="t-card"><img class="avatar" src="<?php echo esc_url( $tviq_team_img ); ?>miles-pretlove.jpg" width="78" height="78" loading="lazy" decoding="async" alt=""><h5>Miles Pretlove</h5><span>VP, Ad Operations</span><a href="mailto:miles@tviq.io">miles@tviq.io</a></div>
      <div class="t-card"><img class="avatar" src="<?php echo esc_url( $tviq_team_img ); ?>steven-gold.jpg" width="78" height="78" loading="lazy" decoding="async" alt=""><h5>Steven Gold</h5><span>VP, Revenue Management</span><a href="mailto:steven@tviq.io">steven@tviq.io</a></div>
    </div>
  </div>
</section>
